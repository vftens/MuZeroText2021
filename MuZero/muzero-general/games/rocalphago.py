...
#from .RocAlphaGo_aug25_keras2_py35.greedy_player_gtp import *
import datetime
import os
...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (3, 19, 19)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        ...
        self.max_moves = 342  # Maximum number of moves if game is not finished before
...
class Rocalphago:
    def __init__(self):
        self.board = np.zeros((19, 19), dtype="int32")
        self.player = 1
    ...
    def get_observation(self):
        ...
        board_to_play = np.full((19, 19), self.player, dtype="int32")
