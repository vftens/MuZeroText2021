...
exports.useTextFieldEventsHandler = function (props, handler, textFieldRef) {
    var _a = react_1["default"].useState(false), inputChanged = _a[0], setInputChanged = _a[1];
    ...
    newProps.onFocus = function () {
        ...
        return (_a = props.onFocus) === null || _a === void 0 ? void 0 : _a.call.apply(_a, tslib_1.__spreadArrays([props], onfocusArgs));
    };
    newProps.onBlur = function () {
        ...
        return (_a = props.onBlur) === null || _a === void 0 ? void 0 : _a.call.apply(_a, tslib_1.__spreadArrays([props], onBlurArgs));
    };
    return newProps;
};
