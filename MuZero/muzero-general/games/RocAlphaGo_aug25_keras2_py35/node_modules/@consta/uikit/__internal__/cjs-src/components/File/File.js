...
exports.File = function (props) {
    ...
    if (loading) {
        var spin = !loadingProgress;
        return (react_1["default"].createElement(FileIconLoading_1.FileIconLoading, tslib_1.__assign({ className: exports.cnFile(null, [className]), size: size }, otherProps), loadingWithProgressSpin && (react_1["default"].createElement("div", { className: exports.cnFile('Loader', { spin: spin, size: size }) },
            react_1["default"].createElement(ProgressSpin_1.ProgressSpin, { className: exports.cnFile('Progress'), size: size, progress: spin ? 50 : loadingProgress, animation: true })))));
    }
