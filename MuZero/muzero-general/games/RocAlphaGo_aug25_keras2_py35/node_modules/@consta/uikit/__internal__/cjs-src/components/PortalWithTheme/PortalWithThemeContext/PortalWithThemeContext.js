...
exports.PortalWithThemeProvider = function (props) {
    var _a = react_1.useState([]), refs = _a[0], setRefs = _a[1];
    ...
    var addRefs = function (addRef) {
        if (addRef.length > 0) {
            var newRefs = tslib_1.__spreadArrays(refs.filter(function (item) { return item.current; }), addRef.filter(function (addItem) {
                if (!addItem.current) {
                    return false;
                }
