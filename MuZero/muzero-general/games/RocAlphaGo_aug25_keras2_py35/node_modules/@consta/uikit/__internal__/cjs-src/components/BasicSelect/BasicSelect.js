...
exports.BasicSelect = function (props) {
    ...
    var _a = usePropsHandler_1.usePropsHandler(cnSelect_1.cnSelect(), props, controlRef), placeholder = _a.placeholder, onBlur = _a.onBlur, onFocus = _a.onFocus, options = _a.options, onChange = _a.onChange, value = _a.value, getOptionLabel = _a.getOptionLabel, disabled = _a.disabled, ariaLabel = _a.ariaLabel, id = _a.id, _b = _a.dropdownRef, dropdownRef = _b === void 0 ? defaultOptionsRef : _b, _c = _a.form, form = _c === void 0 ? types_1.DefaultPropForm : _c, _d = _a.view, view = _d === void 0 ? types_1.DefaultPropView : _d, _e = _a.size, size = _e === void 0 ? types_1.DefaultPropSize : _e, dropdownClassName = _a.dropdownClassName, name = _a.name, restProps = tslib_1.__rest(_a, ["placeholder", "onBlur", "onFocus", "options", "onChange", "value", "getOptionLabel", "disabled", "ariaLabel", "id", "dropdownRef", "form", "view", "size", "dropdownClassName", "name"]);
    var toggleRef = react_1.useRef(null);
    var _f = react_1.useState(false), isFocused = _f[0], setIsFocused = _f[1];
    ...
    }), visibleOptions = _g.visibleOptions, highlightedIndex = _g.highlightedIndex, getToggleProps = _g.getToggleProps, getOptionProps = _g.getOptionProps, isOpen = _g.isOpen, setOpen = _g.setOpen;
