...
exports.SnackBarItem = function (props) {
    ...
    var _b = react_1.useState(null), timerFunctions = _b[0], setTimerFunctions = _b[1];
    var _c = react_1.useState(false), hover = _c[0], setHover = _c[1];
    var _d = react_1.useState(false), timeIsOver = _d[0], setTimeIsOver = _d[1];
