...
exports.ProgressSpin = react_1["default"].forwardRef(function (props, ref) {
    var _a = props.size, size = _a === void 0 ? exports.progressSpinPropSizeDefault : _a, _b = props.progress, progress = _b === void 0 ? 0 : _b, animation = props.animation, className = props.className, otherProps = tslib_1.__rest(props, ["size", "progress", "animation", "className"]);
    var _c = react_1.useMemo(function () { return getSvgParamsBySize(size); }, [size]), sizeOfPixels = _c[0], strokeWidth = _c[1], radius = _c[2], strokeDasharray = _c[3];
    var strokeDashoffset = strokeDasharray - (strokeDasharray * progress) / 100;
    return (react_1["default"].createElement("svg", tslib_1.__assign({}, otherProps, { className: exports.cnProgressSpin(null, [className]), width: sizeOfPixels, height: sizeOfPixels, viewBox: "0 0 " + sizeOfPixels + " " + sizeOfPixels, ref: ref }),
