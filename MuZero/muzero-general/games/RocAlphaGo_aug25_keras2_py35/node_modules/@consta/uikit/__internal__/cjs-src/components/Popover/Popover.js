...
exports.directions = tslib_1.__spreadArrays(exports.directionsStartCenter, exports.directionsStartEdge);
...
exports.Popover = react_1["default"].forwardRef(function (props, componentRef) {
    ...
    var _f = react_1["default"].useState(), anchorClientRect = _f[0], setAnchorClientRect = _f[1];
    ...
    var _h = react_1["default"].useState([]), bannedDirections = _h[0], setBannedDirections = _h[1];
    ...
    useClickOutside_1.useClickOutside({
        ...
        handler: function (event) { return onClickOutside && onClickOutside(event); }
    });
    ...
    if (previousDirection !== direction) {
        if (previousDirection && !bannedDirections.includes(previousDirection)) {
            setBannedDirections(tslib_1.__spreadArrays(bannedDirections, [previousDirection]));
        }
