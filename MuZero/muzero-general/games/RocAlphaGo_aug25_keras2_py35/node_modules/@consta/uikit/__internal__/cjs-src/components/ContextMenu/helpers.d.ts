...
declare type getGroupsResult<ITEM> = Group<ITEM>[];
export declare function getGroups<ITEM>(items: ITEM[], getGroupId?: ContextMenuPropGetGroupId<ITEM>, sortGroup?: ContextMenuPropSortGroup): getGroupsResult<ITEM>;
export {};
