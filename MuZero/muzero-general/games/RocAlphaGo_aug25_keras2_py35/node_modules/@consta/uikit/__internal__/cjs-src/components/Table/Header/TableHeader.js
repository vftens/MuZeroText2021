    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", { className: cnTableHeader('Row', { withVerticalBorder: borderBetweenColumns }) }, headersWithMetaData.map(function (column, columnIdx) {
            ...
            return (react_1["default"].createElement(TableCell_1.TableCell, { type: "header", key: columnIdx, ref: function (ref) {
                    ...
                    (column === null || column === void 0 ? void 0 : column.position.gridIndex) + ((column === null || column === void 0 ? void 0 : column.position.colSpan) || 1) === stickyColumnsGrid },
                column.title,
                react_1["default"].createElement("div", { className: cnTableHeader('Buttons', {
                    ...
                    filters && column.filterable && (react_1["default"].createElement(TableFilterTooltip_1.TableFilterTooltip, { field: column.accessor, isOpened: visibleFilter === column.accessor, options: filtering_1.getOptionsForFilters(filters, column.accessor), values: selectedFilters[column.accessor] || [], onChange: handleTooltipSave, onToggle: handleFilterTogglerClick(column.accessor), className: cnTableHeader('Icon', { type: 'filter' }) })))));
        })),
