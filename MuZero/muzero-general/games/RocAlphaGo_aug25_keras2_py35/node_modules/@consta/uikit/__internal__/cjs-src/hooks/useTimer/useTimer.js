...
function useTimer(config) {
    ...
    var _b = react_1.useState(false), shouldResetTime = _b[0], setShouldResetTime = _b[1];
    var _c = react_1.useState(startTime), time = _c[0], setTime = _c[1];
    var _d = react_1.useState(false), isRunning = _d[0], setIsRunning = _d[1];
