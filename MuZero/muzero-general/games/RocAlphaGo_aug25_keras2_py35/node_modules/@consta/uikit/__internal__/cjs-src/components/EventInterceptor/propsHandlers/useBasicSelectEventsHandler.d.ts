...
export declare const useBasicSelectEventsHandler: (props: SimpleSelectProps<unknown>, handler: EventInterceptorHandler, controlRef: React.RefObject<HTMLDivElement | null>) => {
    options: unknown[];
    id: string;
    placeholder?: string | undefined;
    ariaLabel?: string | undefined;
    getOptionLabel(arg: unknown): string;
    onBlur?: (((event?: React.FocusEvent<HTMLInputElement> | undefined) => void) & ((event: React.FocusEvent<HTMLDivElement>) => void)) | undefined;
    onFocus?: (((event?: React.FocusEvent<HTMLInputElement> | undefined) => void) & ((event: React.FocusEvent<HTMLDivElement>) => void)) | undefined;
    children?: undefined;
